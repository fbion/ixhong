...
<%
	...
	String yborderid            = formatString(request.getParameter("yborderid"));

	Map<String, String> result	= TZTService.queryByOrder(orderid, yborderid);
	String merchantaccount		= formatString(result.get("merchantaccount"));
	String orderidFromYeepay   	= formatString(result.get("orderid"));
	String yborderidFromYeepay  = formatString(result.get("yborderid"));
	...
	<body>
		...
		<table width="70%" border="0" align="center" cellpadding="5" cellspacing="0" 
			...
			<tr>
				...
				<td width="5%"  align="center"> : </td> 
				<td width="50%" align="left"> <%=yborderidFromYeepay%> </td>
				<td width="5%"  align="center"> - </td> 
