...
public class RSAUtils {
    ...
    public static Map<String, String> generateKeyPair() throws Exception {
        ...
        String pub = new String(Base64.encodeBase64(publicKeyBytes), DEFAULT_ENCODING);
        /** 得到私钥 */
        Key privateKey = kp.getPrivate();
        byte[] privateKeyBytes = privateKey.getEncoded();
        String pri = new String(Base64.encodeBase64(privateKeyBytes), DEFAULT_ENCODING);
    ...
    public static String encrypt(String source, String publicKey)
        ...
        return new String(Base64.encodeBase64(b1), DEFAULT_ENCODING);
    }
